...
class RSSFeedsSettings(BaseSiteSetting):
    ...
    feed_model_name = models.CharField(
        _("Feed model name"), max_length=255, help_text=_("Model to be used for feed generation"), null=True, blank=True
    )
    feed_title = models.CharField(_("Feed title"), max_length=255, help_text=_("Title of Feed"), null=True, blank=True)
    feed_link = models.URLField(_("Feed link"), max_length=255, help_text=_("link for Feed"), null=True, blank=True)
    feed_description = models.CharField(
        _("Feed description"), max_length=255, help_text=_("Description of field"), null=True, blank=True
    )
    feed_author_email = models.EmailField(
        _("Feed author email"), max_length=255, help_text=_("Email of author"), null=True, blank=True
    )
    ...
    feed_item_content_field = models.CharField(
        _("Feed item content field"), max_length=255, help_text=_("Content Field for feed item"), null=True, blank=True
    )
    feed_image_in_content = models.BooleanField(
        _("Feed image in content"), help_text=_("Add feed image to content encoded field"), default=True
    )
